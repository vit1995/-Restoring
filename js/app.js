...
***************************************************************************** */
        ...
        document.querySelector(".footer__menu").addEventListener("click", (function(e) {
            const subMenu = document.querySelector(".footer__list");
            const targetSub = e.target.closest(".footer__button");
            if (targetSub) subMenu.classList.toggle("active-sub");
        }));
        document.addEventListener("click", (function(e) {
            const subMenu = document.querySelector(".footer__list");
            const targetSub = e.target.closest(".footer__menu");
            if (!targetSub) subMenu.classList.remove("active-sub");
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
